...
public class DialogData
{
    ...
    bool _isPlayable;
    Dictionary<DialogData, DialogChangeCondition[]> _possibleNextDialogs;
    ...
    public Dictionary<DialogData, DialogChangeCondition[]> PossibleNextDialogs { get { return _possibleNextDialogs; } set { _possibleNextDialogs = value; } }

    public DialogData(Dialog dialog, string branch)
    {
        _dialog = dialog;
        _branch = branch;
        _possibleNextDialogs = new Dictionary<DialogData, DialogChangeCondition[]>();
    }
}
